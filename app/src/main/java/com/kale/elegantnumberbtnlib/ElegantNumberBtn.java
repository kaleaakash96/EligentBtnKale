...
public class ElegantNumberBtn extends RelativeLayout {
    ...
    public ElegantNumberBtn(Context context) {
        super(context);
        this.context = context;
        initView();
    }

    public ElegantNumberBtn(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.attrs = attrs;
        initView();
    ...
    public ElegantNumberBtn(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnValueChangeListener {
        void onValueChange(ElegantNumberBtn view, int oldValue, int newValue);
    }
